...
function colision_lineal_capas(pos_x_1, pos_y_1, pos_x_2, pos_y_2, superficie_posterior, superficie_frontal, entidad = obj_jugador) {
	// Determinar colisiones
...
function calcular_colision_linea(superficie, mascara = 20, entidad = obj_jugador) {
...
function verificar_colision_aterrizaje(superficie_normal, superficie_posterior, superficie_frontal, mascara = 20, entidad = obj_jugador) {
	...
	var colision_capa_posterior = calcular_colision_linea(superficie_posterior) and (entidad.capa_nivel == 0);
	var colision_capa_frontal = calcular_colision_linea(superficie_frontal) and (entidad.capa_nivel == 1);
...
function verificar_colision_tipo_suelo(superficie_normal, superficie_posterior, superficie_frontal, entidad = obj_jugador) {
	// Determinar colisiones
	var colision_normal = calcular_colision_linea(superficie_normal);
	var colision_capa_posterior = calcular_colision_linea(superficie_posterior) and (entidad.capa_nivel == 0);
	var colision_capa_frontal = calcular_colision_linea(superficie_frontal) and (entidad.capa_nivel == 1);
