...
#macro INPUT_SDL2_DATABASE_PATH    "lib/input/sdl2.txt"                //Path to the SDL2 database to read gamepad remapping definitions from
#macro INPUT_CONTROLLER_TYPE_PATH  "lib/input/controllertypes.csv"     //Path to the controller type database to read gamepad types from
#macro INPUT_BLACKLIST_PATH        "lib/input/controllerblacklist.csv" //Path to the controller blacklist database to read from