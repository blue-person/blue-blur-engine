...
view_xport[0] = 0;
view_yport[0] = 0;
view_wport[0] = ANCHO_RESOLUCION;
view_hport[0] = ALTURA_RESOLUCION;
...
camera_set_proj_mat(camara, matrix_build_projection_ortho(ANCHO_RESOLUCION, ALTURA_RESOLUCION, pos_min, pos_max));
