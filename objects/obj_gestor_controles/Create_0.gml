...
boton_mantenido = function(nombre_boton) {
	if (self.permitir_lectura) then return input_check(nombre_boton);
	return false;
}

boton_presionado = function(nombre_boton) {
	if (self.permitir_lectura) then return input_check_pressed(nombre_boton);
	return false;
}

boton_liberado = function(nombre_boton) {
	if (self.permitir_lectura) then return input_check_released(nombre_boton);
	return false;
}