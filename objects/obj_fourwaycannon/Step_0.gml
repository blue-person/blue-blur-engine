if (!activar_evento) {
    ...
    if (realizar_animacion) {
		...
		if (input_check_released("boton_arriba") or input_check_released("boton_abajo") or input_check_released("boton_derecha") or input_check_released("boton_izquierda")) { 
