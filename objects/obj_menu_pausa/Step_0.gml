...
if (pausar_juego) {
	boton_necesario = input_check_pressed("boton_entrada") or input_check_pressed("boton_salto");
} else {
	boton_necesario = input_check_pressed("boton_entrada");
}
...
if (pausar_juego) {
    if (input_check_pressed("boton_abajo")) {
    ...
    } else if (input_check_pressed("boton_arriba")) {
        if (nivel_actual == rm_hub_world) {
			opcion_menu = 0;
