if (mostrar_en_pantalla) {
	...
	dibujar_texto_simple(pos_x_tiempo + 30, pos_y_tiempo + 5, cantidad_tiempo, font_numeros, fa_top, fa_top, transparencia);
	
	// Rings
	draw_sprite(spr_contador_rings, 0, pos_x_rings, pos_y_rings);
	dibujar_texto_simple(pos_x_rings + 30, pos_y_rings + 3, cantidad_rings, font_numeros, fa_top, fa_top, transparencia);
	
	// Vidas
    draw_sprite(hud_vidas, 0, pos_x_vidas, pos_y_vidas);
	dibujar_texto_simple(pos_x_vidas + 30, pos_y_vidas + 3, cantidad_vidas, font_numeros, fa_top, fa_top, transparencia);
