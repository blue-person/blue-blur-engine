...
dibujar_texto_sombreado(pos_x_nombre, pos_y_nombre + 5, global.nombre_nivel, 2, color, c_white, 1, 1);

draw_sprite_ext(spr_marco_subtitulo, 0, x, pos_y_mision, 1.5, 1, 0, c_white, transparencia_barra);
draw_set_font(font_principal_cursiva);
dibujar_texto_sombreado(pos_x_mision, pos_y_mision + 2, global.objetivo_nivel, 2, color, c_white, 0.5, 0.5);
