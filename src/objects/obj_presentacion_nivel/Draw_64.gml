...
draw_sprite_ext(spr_pantalla_morada, 0, mitad_ancho_resolucion, mitad_altura_resolucion, 1, 1, 0, c_white, transparencia_transicion_gris);
...
textos.escritura_sombreada(pos_x_nombre, pos_y_nombre + 5, descripcion_nivel.nombre, 2, color, c_white, 1, 1);

draw_sprite_ext(spr_marco_subtitulo, 0, x, pos_y_mision, 1.5, 1, 0, c_white, transparencia_barra);
draw_set_font(font_principal_cursiva);
textos.escritura_sombreada(pos_x_mision, pos_y_mision + 2, descripcion_nivel.objetivo, 2, color, c_white, 0.5, 0.5);
...
draw_sprite_ext(spr_pantalla_morada, 0, mitad_ancho_resolucion, mitad_altura_resolucion, 1, 1, 0, c_white, trasnparencia_invisible);