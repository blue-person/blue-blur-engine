var colision_a = (collision_line(x - 12, y - 3, x + 7, y - 3, obj_jugador, true, true) and (image_xscale == 1));
var colision_b = (collision_line(x + 12, y - 3, x - 7, y - 3, obj_jugador, true, true) and (image_xscale == -1));
