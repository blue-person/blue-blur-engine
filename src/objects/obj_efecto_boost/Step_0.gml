if (activar_efecto) {
	...
	if (!controles.boton_mantenido("boton_boost") or boost_vacio or sin_impulso_aereo or condiciones_velocidad
	    or controles.boton_liberado("boton_boost") or obj_jugador.zona_superada
