...
input_icons_keyboard_and_mouse()
    .add("space", spr_icono_espacio_teclado)
    .add("enter", spr_icono_entrada_teclado)
    .add("arrow up", spr_icono_arriba_teclado)
    .add("arrow down", spr_icono_abajo_teclado)
    .add("arrow left", spr_icono_izquierda_teclado)
    .add("arrow right", spr_icono_derecha_teclado)
    .add("Z", spr_icono_z_teclado)
    .add("C", spr_icono_c_teclado)
    .add("X", spr_icono_x_teclado)
...
input_icons_gamepad(INPUT_GAMEPAD_TYPE_XBOX_ONE)
    .add("gamepad face south", spr_icono_a_xbox)
    .add("gamepad face east", spr_icono_b_xbox)
    .add("gamepad face west", spr_icono_x_xbox)
    .add("gamepad face north", spr_icono_y_xbox)
    ...
    .add("gamepad start", spr_icono_entrada_xbox)
    ...
    .add("gamepad thumbstick l left", spr_icono_izquierda_xbox)
    .add("gamepad thumbstick l right", spr_icono_derecha_xbox)
    .add("gamepad thumbstick l up", spr_icono_arriba_xbox)
    .add("gamepad thumbstick l down", spr_icono_abajo_xbox)
...
input_icons_gamepad(INPUT_GAMEPAD_TYPE_PS5)
    .add("gamepad face south", spr_icono_cruz_playstation)
    .add("gamepad face east", spr_icono_circulo_playstation)
    .add("gamepad face west", spr_icono_cuadrado_playstation)
    .add("gamepad face north", spr_icono_triangulo_playstation)
    ...
    .add("gamepad start", spr_icono_entrada_playstation)
    .add("gamepad dpad left", "dpad left")
    .add("gamepad dpad right", "dpad right")
    .add("gamepad dpad up", "dpad up")
    .add("gamepad dpad down", "dpad down")

    .add("gamepad thumbstick l left", spr_icono_izquierda_playstation)
    .add("gamepad thumbstick l right", spr_icono_derecha_playstation)
    .add("gamepad thumbstick l up", spr_icono_arriba_playstation)
    .add("gamepad thumbstick l down", spr_icono_abajo_playstation)
