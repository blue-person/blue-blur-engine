function gestion_accion_salto() {
	if (controles.boton_presionado("boton_salto") and tocando_suelo and ((accion == -4) or (accion == 0) or (accion == 2) or (accion == 9) or (accion == 11))) {
        accion = 1;
		tocando_suelo = false;
    ...
    if (controles.boton_liberado("boton_salto") and (velocidad_vertical < altura_salto_minima) and (accion == 1)) {
